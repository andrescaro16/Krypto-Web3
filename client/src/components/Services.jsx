		...
		<div className='flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4'>
			...
			<div className='flex-1 flex flex-col justify-start items-center'>
				...
				<ServiceCard
					...
					subtitle='Maximize gains with competitive rates. Get the most value for your transactions, bid farewell to overpaying'
				/>
				<ServiceCard
					color='bg-[#F84550]'
					title='Fastest transactions'
					icon={<RiHeart2Fill fontSize={21} className='text-white' />}
					subtitle='Say hello to instant results. Our cutting-edge technology ensures swift, seamless trades and transfers, no time wasted'
				/>
			</div>
		</div>
	</div>
